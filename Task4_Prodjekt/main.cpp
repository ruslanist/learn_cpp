...
int main(int argc, char*argv[]) {
	...
	for(int i = 0; i < code_lines.size(); i++) {
		...
		if(current_operator == "-") {
			...
			string second_oper;
			stream >> first_oper >> second_oper;
			cout << "Производится вычетание " << first_oper << " " << second_oper << endl;	
		}
		...
		if(current_operator == "*") {
                        ...
                        string second_oper;
                        stream >> first_oper >> second_oper;
                        cout << "Производится умножение " << first_oper << " " << second_oper << endl;
                }
		...
		if(current_operator == "/") {
                        ...
                        string second_oper;
                        stream >> first_oper >> second_oper;
                        cout << "Производится деление " << first_oper << " " << second_oper << endl;
                }
